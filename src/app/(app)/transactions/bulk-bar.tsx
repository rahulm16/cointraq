  ...
  return (
    <>
        ...
        {count > 0 && (
          ...
          >
            ...
            >
              ...
              <span className="text-[13px] font-semibold text-text-primary tnum px-1">{count}</span>
              ...
              <button
                ...
                disabled={pending}
                aria-label={`Delete ${count} transactions`}
      ...
      <ConfirmDialog
        ...
        body="This permanently removes them. Balances will recompute."
        confirmLabel="Delete"
        onConfirm={() => {
